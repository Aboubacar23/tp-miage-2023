...
+ Oui le code est structuré en couche. Nous ppouvons constaté la vue applicative dans un dossier et les ressources dans un autre dossier et dans le package principal, toutes les parties de l'application sont dans un fichier dédié.

* Le controller pour la partie logique de l'application(service)
