...
*Où se trouve le code métier (voir la règle de gestion RG 1) ?
    ...
    +e code metier de l'exo 1 se trouve`src/main/java/com.acme.todolist/TodoListController.java`
...
*Expliquer cette ligne de commande (y compris les options utilisées)*
 + soit à expliquer la ligne de commande 
    ...
    -t Allouer un pseudo-terminal    -e : force Docker a utiliser un driver exec sépcifique
